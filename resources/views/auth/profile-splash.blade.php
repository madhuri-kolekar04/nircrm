...
<body>
    ...
    <div class="splash-container">
        <div class="profile-image-wrapper">
            <img src="{{ (!empty(Auth::user()->profile_photo_path)) ? url('upload/admin_images/' . Auth::user()->profile_photo_path) : url('upload/no_image.jpg') }}" 
                 alt="{{ Auth::user()->name }}" 
                 class="profile-image">
        </div>
    ...
    <script>
        ...
        setTimeout(function() {
            ...
            const intendedUrl = '{{ session()->get('url.intended', route('attendance.dashboard')) }}';
