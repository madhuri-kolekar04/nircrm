                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="{{ route('menu-controller.create') }}" class="btn btn-primary btn-sm ml-2">
                                <i class="fas fa-plus"></i> Add Menu Item
                            </a>
                            <a href="{{ route('employee-menu-controller.index') }}" class="btn btn-info btn-sm ml-2">
...
<script>
    ...
    function loadModalMenuPermissions(roleId) {
        ...
        $.get('{{ route("menu-controller.api.permissions") }}', { role_id: roleId })
            .done(function(data) {
    ...
    function saveModalMenuPermissions() {
        ...
        $.ajax({
            url: '{{ route("menu-controller.api.update") }}',
            method: 'POST',
            data: {
                role_id: roleId,
                menus: menus
            ...
            const row = `
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        ${isVisible ? `
                            <a href="{{ route('page-customization.index') }}?menu_name=${encodeURIComponent(menu.name)}&menu_url=${encodeURIComponent(menu.url)}&role_id=${roleId}" 
