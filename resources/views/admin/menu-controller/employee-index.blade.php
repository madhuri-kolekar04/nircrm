...
<script>
    ...
    function loadEmployees() {
        ...
        $.get('{{ route("employee-menu-controller.api.employees") }}', { 
    ...
    function loadEmployeeMenuPermissions(employeeId) {
        ...
        $.get('{{ route("employee-menu-controller.api.permissions") }}', { 
            ...
            if (data.length === 0) {
                ...
                if (employeeRole) {
                    ...
                    if (roleId) {
                        ...
                        $.get('{{ route("menu-controller.api.permissions") }}', { 
                            role_id: roleId 
                        })
    ...
    function saveSingleMenuPermission(employeeId, menuName, isVisible) {
        ...
        // Save via API
        $.post('{{ route("employee-menu-controller.api.update") }}', permissionData)
