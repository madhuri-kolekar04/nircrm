        ...
        <div class="profile-sidebar">
            <div class="profile-card">
                <div class="profile-avatar-section">
                    ...
                    <h3 class="profile-name">{{ $adminData->name ?? 'Unknown User' }}</h3>
                    ...
                    <div class="info-body">
                        <div class="info-grid">
                            <div class="info-item">
                                ...
                                <div class="info-value">{{ $adminData->name ?? 'N/A' }}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Email Address</div>
                                <div class="info-value">{{ $adminData->email ?? 'N/A' }}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Contact Number</div>
                                <div class="info-value">{{ $adminData->contact_number ?? 'N/A' }}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Address</div>
                                <div class="info-value">{{ $adminData->address ?? 'N/A' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="info-body">
                        <div class="info-grid">
                            <div class="info-item">
                                ...
                                <div class="info-value">{{ $adminData->employeeID ?? 'N/A' }}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Position</div>
                                <div class="info-value">{{ $adminData->position ?? 'N/A' }}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Department</div>
                                <div class="info-value">
                                    @if(isset($adminData->Groupname) && isset($adminData->Groupname->Group))
                                        {{ $adminData->Groupname->Group }}
                                    @elseif(isset($adminData->department) && is_object($adminData->department))
                                        {{ $adminData->department->name ?? 'N/A' }}
                                    @elseif(isset($adminData->department) && is_string($adminData->department))
                                        @php
                ...
                <div class="profile-card">
                    ...
                    <div class="info-body">
                        <div class="stats-grid">
                            <div class="stat-item">
                                <div class="stat-value">
                                    @if($adminData->created_at)
                                        {{ \Carbon\Carbon::parse($adminData->created_at)->format('M j, Y') }}
                                    @else
                                        N/A
                                    @endif
                                </div>
                            ...
                            <div class="stat-item">
                                <div class="stat-value">
                                    @if($adminData->email_verified_at)
                            ...
                            <div class="stat-item">
                                <div class="stat-value">
                                    @if($adminData->last_login_at)
                                        {{ \Carbon\Carbon::parse($adminData->last_login_at)->diffForHumans() }}
                                    @else
                                        Never
                                    @endif
                                </div>
                            ...
                            <div class="stat-item">
                                <div class="stat-value">
                                    <i class="fas fa-circle text-success"></i> {{ $adminData->status ?? 'Active' }}
                                </div>
