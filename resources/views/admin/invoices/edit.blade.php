                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="project_name" name="project_name" value="{{ $invoice->project_name }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="project_topic" class="form-label">Project Topic *</label>
                                    <input type="text" class="form-control" id="project_topic" name="project_topic" value="{{ $invoice->project_topic }}" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="project_full_details" class="form-label">Project Full Details *</label>
                                    <textarea class="form-control" id="project_full_details" name="project_full_details" rows="3" required>{{ $invoice->project_full_details }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="start_date" class="form-label">Start Date *</label>
                                    <input type="date" class="form-control" id="start_date" name="start_date" value="{{ $invoice->start_date->format('Y-m-d') }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="end_date" class="form-label">End Date *</label>
                                    <input type="date" class="form-control" id="end_date" name="end_date" value="{{ $invoice->end_date->format('Y-m-d') }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="department_id" name="department_id" required style="color: black; font-weight: bold;">
                                        ...
                                        @foreach($departments as $id => $name)
                                            <option value="{{ $id }}" {{ $invoice->department == $name ? 'selected' : '' }} style="color: black; font-weight: bold;">{{ $name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="customer_email" name="customer_email" value="{{ $invoice->customer_email }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="customer_phone" class="form-label">Customer Phone *</label>
                                    <input type="text" class="form-control" id="customer_phone" name="customer_phone" value="{{ $invoice->customer_phone }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="customer_address" class="form-label">Customer Address *</label>
                                    <textarea class="form-control" id="customer_address" name="customer_address" rows="2" required>{{ $invoice->customer_address }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="advance_payment" name="advance_payment" step="0.01" min="0" value="{{ $invoice->advance_payment }}" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label for="remaining_payment" class="form-label">Remaining Payment *</label>
                                    <input type="number" class="form-control" id="remaining_payment" name="remaining_payment" step="0.01" min="0" value="{{ $invoice->remaining_payment }}" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label for="gst" class="form-label">GST *</label>
                                    <input type="number" class="form-control" id="gst" name="gst" step="0.01" min="0" value="{{ $invoice->gst }}" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label class="form-label">Total Payment</label>
                                    <div class="form-control bg-light" id="total_payment_display">₹{{ number_format($invoice->total_payment, 2) }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12">
                                <div id="installments-container">
                                    ...
                                    @endphp
                                    @for($i = 0; $i < max(3, $installmentCount); $i++)
                                    <div class="installment-row mb-3" data-index="{{ $i }}">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label class="form-label">Installment {{ $i + 1 }} Amount</label>
                                                <input type="number" step="0.01" class="form-control" name="installment_amounts[{{ $i }}]" 
                                                       value="{{ $installments[$i]['amount'] ?? '' }}" placeholder="0.00">
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label">Due Date</label>
                                                <input type="date" class="form-control" name="installment_dates[{{ $i }}]" 
                                                       value="{{ $installments[$i]['date'] ?? '' }}">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label">Notes</label>
                                                <input type="text" class="form-control" name="installment_notes[{{ $i }}]" 
                                                       value="{{ $installments[$i]['notes'] ?? '' }}" placeholder="Optional notes">
                                            </div>
                                            <div class="col-md-2">
