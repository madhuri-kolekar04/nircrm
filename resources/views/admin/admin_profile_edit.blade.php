...
<div class="profile-edit-container">
    ...
    <div class="profile-edit-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-right">
                <a href="{{ route('admin.profile') }}" class="btn-cancel" style="background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.3);">
    ...
    <div class="profile-edit-content">
        ...
        <div class="profile-edit-sidebar">
            <div class="profile-edit-card">
                <div class="profile-avatar-section">
                    ...
                    <h3 class="profile-name">{{ $editData->name ?? 'Unknown User' }}</h3>
        ...
        <div class="profile-edit-main">
            <form method="post" action="{{ route('admin.profile.store') }}" enctype="multipart/form-data" id="profileEditForm">
                @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name" value="{{ $editData->name }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control" id="email" value="{{ $editData->email }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" name="contact_number" class="form-control" id="contact_number" value="{{ $editData->contact_number }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="image-preview" id="imagePreview">
                                            <img src="{{ (!empty($editData->profile_photo_path)) ? url('upload/admin_images/'.$editData->profile_photo_path) : url('upload/no_image.jpg') }}" alt="Current Profile Image" id="previewImg">
                                        </div>
                                    </div>
                                </div>
                            </div>
