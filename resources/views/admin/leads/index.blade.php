...
@section('page-title', 'Leads Generation')
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{ route('duedate.index') }}" class="btn btn-outline-warning position-relative" 
                                   @if($todayDueDateCount > 0) 
                                       title="{{ $todayDueDateCount }} lead(s) due today - Click to manage due dates" 
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <form method="GET" action="{{ route('leads.index') }}" style="display: inline;">
                                <select name="filter_value" class="form-select form-select-sm filter-dropdown" onchange="this.form.submit()" style="min-width: 120px; background: linear-gradient(135deg, #0d6efd 0%, #0b5ed7 100%); color: white; border: none; font-weight: 600; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                                    ...
                                    @foreach(App\Models\Lead::getLeadStatuses() as $value => $label)
                                        <option value="{{ $value }}" 
                                                {{ request('filter_value') == $value && request('filter_type') == 'status' ? 'selected' : '' }}
                                                style="background-color: {{ App\Models\Lead::getStatusColorForValue($value) }}20; color: {{ App\Models\Lead::getStatusColorForValue($value) }};">
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <form method="GET" action="{{ route('leads.index') }}" style="display: inline;">
                                <select name="priority" class="form-select form-select-sm filter-dropdown" onchange="this.form.submit()" style="min-width: 100px; background: linear-gradient(135deg, #fd7e14 0%, #e8590c 100%); color: white; border: none; font-weight: 600; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                                    ...
                                    @foreach(App\Models\Lead::getPriorities() as $value => $label)
                                        <option value="{{ $value }}" 
                                                ...
                                                style="background-color: {{ App\Models\Lead::getPriorityColorForValue($value) }}20; color: {{ App\Models\Lead::getPriorityColorForValue($value) }};">
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                @if(request('filter_type') && request('filter_value'))
                                    ...
                                    <input type="hidden" name="filter_value" value="{{ request('filter_value') }}">
                                @endif
                                @if(request('source'))
                                    <input type="hidden" name="source" value="{{ request('source') }}">
                                @endif
                            ...
                            <form method="GET" action="{{ route('leads.index') }}" style="display: inline;">
                                <select name="work_status" class="form-select form-select-sm filter-dropdown" onchange="this.form.submit()" style="min-width: 120px; background: linear-gradient(135deg, #6f42c1 0%, #5a2d91 100%); color: white; border: none; font-weight: 600; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                                    ...
                                    <option value="Active" {{ request('work_status') == 'Active' ? 'selected' : '' }}>Active</option>
                                    <option value="NO" {{ request('work_status') == 'NO' ? 'selected' : '' }}>NO</option>
                                </select>
                                @if(request('search'))
                                    <input type="hidden" name="search" value="{{ request('search') }}">
                                @endif
                            ...
                            <a href="{{ route('leads.index') }}" class="btn btn-outline-danger btn-sm" style="border-radius: 0.5rem; font-weight: 600; transition: all 0.3s ease;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-select form-select-sm status-select" 
                                                    ...
                                                    style="min-width: 100px; background-color: {{ App\Models\Lead::getStatusColorForValue($lead->lead_status) }}20; color: {{ App\Models\Lead::getStatusColorForValue($lead->lead_status) }}; font-weight: 600;">
                                                @foreach(App\Models\Lead::getLeadStatuses() as $value => $label)
                                                    <option value="{{ $value }}" 
                                                            {{ $lead->lead_status == $value ? 'selected' : '' }}
                                                            style="background-color: {{ App\Models\Lead::getStatusColorForValue($value) }}20; color: {{ App\Models\Lead::getStatusColorForValue($value) }};">
                                                        {{ $label }}
                                                    </option>
                                                @endforeach
                                        ...
                                        <td>
                                            <select class="form-select form-select-sm priority-select" 
                                                    data-lead-id="{{ $lead->id }}" 
                                                    data-field="priority"
                                                    style="min-width: 80px; background-color: {{ App\Models\Lead::getPriorityColorForValue($lead->priority) }}20; color: {{ App\Models\Lead::getPriorityColorForValue($lead->priority) }}; font-weight: 600;">
                                                @foreach(App\Models\Lead::getPriorities() as $value => $label)
                                                    <option value="{{ $value }}" 
                                                            {{ $lead->priority == $value ? 'selected' : '' }}
                                                            style="background-color: {{ App\Models\Lead::getPriorityColorForValue($value) }}20; color: {{ App\Models\Lead::getPriorityColorForValue($value) }};">
                                                        {{ $label }}
                                                    </option>
                                                @endforeach
                                        ...
                                        <td>
                                            <select class="form-select form-select-sm source-select" 
                                                ...
                                                @endforeach
                                                @if(!array_key_exists($lead->source, App\Models\Lead::getSources()))
                                        ...
                                        <td>
                                            <div style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="{{ $lead->description ?? $lead->notes ?? 'N/A' }}">
                                                {{ \Illuminate\Support\Str::limit($lead->description ?? $lead->notes ?? 'N/A', 50) }}
                                            </div>
                                        </td>
                                        <td>
                                            <div style="display: flex; align-items: center; gap: 8px;">
                                                <div style="width: 28px; height: 28px; border-radius: 50%; background: #00a884; display: flex; align-items: center; justify-content: center; color: white; font-size: 0.75rem; font-weight: 600;">
                                                    {{ $lead->assigned_to && $lead->assignedUser ? strtoupper(substr($lead->assignedUser->name, 0, 1)) : 'U' }}
                                                </div>
                                                <span>{{ $lead->assignedUser->name ?? 'Unassigned' }}</span>
                                            </div>
                                        </td>
                                        <td class="extra-column" style="display: none;">
                                            <span class="badge {{ $lead->work_status == 'Active' ? 'bg-success' : ($lead->work_status == 'NO' ? 'bg-danger' : 'bg-secondary') }}">
                                                {{ $lead->work_status ?? 'N/A' }}
                                            </span>
                                        </td>
                                        <td class="extra-column" style="display: none;">
                                            {{ $lead->work_type ?? '-' }}
                                        ...
                                        <td class="extra-column" style="display: none;">
                                            {{ $lead->current_service ?? '-' }}
                                        </td>
                                        <td class="extra-column" style="display: none;">
                                            {{ $lead->date_of_completion ? $lead->date_of_completion->format('Y-m-d') : '-' }}
                                        </td>
                                        <td class="extra-column" style="display: none;">
                                            {{ $lead->due_date ? $lead->due_date->format('Y-m-d') : '-' }}
                                        </td>
                                        <td>
                                            <div style="display: flex; gap: 8px;">
                                                <button type="button" class="btn btn-sm btn-info" onclick="viewLead({{ $lead->id }})">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button type="button" class="btn btn-sm btn-secondary" onclick="createQuotation({{ $lead->id }})" title="Create Quotation">
                                                    <i class="fas fa-file-invoice"></i>
                                                </button>
                                                                                                <button type="button" class="btn btn-sm btn-warning" onclick="manageLead({{ $lead->id }})" title="Reaction">
                                                    <i class="fas fa-face-smile"></i>
                                                </button>
                                                <button type="button" class="btn btn-sm btn-success position-relative" onclick="editLead({{ $lead->id }})" title="Edit Lead ({{ $lead->empty_fields_count }} empty fields)">
                                                    <i class="fas fa-edit"></i>
                                                    @if($lead->empty_fields_count > 0)
                                                        <span class="position-absolute top-0 start-100 translate-middle empty-fields-badge">
                                                            {{ $lead->empty_fields_count }}
                                                        </span>
                                                    @endif
                                                </button>
                                                <button type="button" class="btn btn-sm btn-danger" onclick="deleteLead({{ $lead->id }})">
                    ...
                    <div class="col-md-6">
                        <div class="card text-center h-100">
                            <div class="card-body d-flex flex-column justify-content-center">
                                ...
                                <a href="{{ route('leads.create.new') }}" class="btn btn-primary">Add Lead</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card text-center h-100">
                            <div class="card-body d-flex flex-column justify-content-center">
                                ...
                                <a href="{{ route('leads.direct.upload') }}" class="btn btn-success">Upload Excel</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="emailModal" tabindex="-1" aria-labelledby="emailModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="emailForm" method="POST" action="{{ route('leads.send.email') }}">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.viewLead = function(leadId) {
        ...
        window.open('{{ route("leads.show", ":id") }}'.replace(':id', leadId), '_blank');
    };
    
    window.editLead = function(leadId) {
        console.log('Edit lead clicked:', leadId);
        window.open('{{ route("leads.edit.new", ":id") }}'.replace(':id', leadId), '_blank');
    };
    ...
    window.loadStatusesAndPriorities = function() {
        ...
        fetch('{{ route("staprio.priorities") }}', {
            method: 'GET',
            headers: headers
        })
            .then(response => response.json())
    ...
    window.saveStatusEdit = function(id) {
        ...
        fetch(`{{ route("staprio.update", ":id") }}`.replace(':id', id), {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
    ...
    window.deleteStatus = function(id) {
        if (confirm('Are you sure you want to delete this status?')) {
            fetch(`{{ route("staprio.destroy", ":id") }}`.replace(':id', id), {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                                ...
                                <div class="row text-center">
                                    <div class="col-md-3">
                                        <div class="reaction-stat-card">
                                            ...
                                            <h5 class="text-success">{{ App\Models\LeadReaction::where('reaction_type', 'positive')->count() }}</h5>
                                    ...
                                    <div class="col-md-3">
                                        <div class="reaction-stat-card">
                                            <div class="reaction-emoji">😐</div>
                                            <h5 class="text-warning">{{ App\Models\LeadReaction::where('reaction_type', 'neutral')->count() }}</h5>
                                    ...
                                    <div class="col-md-3">
                                        <div class="reaction-stat-card">
                                            <div class="reaction-emoji">😔</div>
                                            <h5 class="text-danger">{{ App\Models\LeadReaction::where('reaction_type', 'negative')->count() }}</h5>
                                    ...
                                    <div class="col-md-3">
                                        <div class="reaction-stat-card">
                                            <div class="reaction-emoji">📊</div>
                                            <h5 class="text-primary">{{ App\Models\LeadReaction::count() }}</h5>
                            ...
                            <div class="card-body">
                                @php
                                    $recentReactions = App\Models\LeadReaction::with(['lead', 'user'])
                                        ...
                                        ->get();
                                @endphp
                                @if($recentReactions->count() > 0)
                                    @foreach($recentReactions as $reaction)
                                        <div class="d-flex align-items-center mb-2 p-2 border rounded">
                                            <div class="reaction-emoji me-3">
                                                {{ $reaction->getReactionEmoji() }}
                                            </div>
                                            <div class="flex-grow-1">
                                                <strong>{{ $reaction->lead->name ?? 'Unknown Lead' }}</strong>
                                                <br>
                                            ...
                                            <div>
                                                <span class="badge bg-info">{{ $reaction->reaction_type }}</span>
                                            </div>
                                        </div>
                                    @endforeach
                                @else
            ...
            <div class="modal-footer">
                ...
                <a href="{{ route('reactions-system.index') }}" class="btn btn-primary">
