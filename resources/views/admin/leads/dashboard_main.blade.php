    ...
    <div class="col-md-3">
        <div class="card stats-card text-center h-100">
            <div class="card-body">
                ...
                <h3 class="text-danger">{{ $dashboardData['totalLeads'] }}</h3>
            </div>
        </div>
    </div>
        ...
        <div class="card stats-card text-center h-100">
            <div class="card-body">
               <i class="fas fa-calendar-week fa-2x text-primary mb-2"></i>
                ...
                <h3 class="text-warning">{{ $dashboardData['qualifiedLeads'] }}</h3>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card stats-card text-center h-100">
            <div class="card-body">
                ...
                <h3 class="text-info">{{ $dashboardData['pipelineLeads'] }}</h3>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card stats-card text-center h-100">
            <div class="card-body">
                ...
                <h3 class="text-success">{{ $dashboardData['activeClients'] }}</h3>
            </div>
        </div>
    </div>
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-3">
                    <span class="badge bg-info"> {{ $dashboardData['totalLeads'] }} leads with due dates</span>
