                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('website') is-invalid @enderror" 
                                           id="website" name="website" value="{{ old('website', $lead->website) }}" placeholder="https://example.com">
                                    @error('website')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('address') is-invalid @enderror" 
                                           id="address" name="address" value="{{ old('address', $lead->address) }}">
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('source') is-invalid @enderror" 
                                        ...
                                        @endforeach
                                        @if(!in_array($lead->source, array_keys(App\Models\Lead::getSources())))
                                    ...
                                    <div class="mt-2" id="custom_source_div" style="display: none;">
                                        <input type="text" class="form-control @error('custom_source') is-invalid @enderror" 
                                               ...
                                               value="{{ old('custom_source', !in_array($lead->source, array_keys(App\Models\Lead::getSources())) ? $lead->source : '') }}" 
                                               placeholder="Enter custom source" maxlength="255">
                                        @error('custom_source')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('follow_up_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('follow_up_date', $lead->follow_up_date ? $lead->follow_up_date->format('Y-m-d') : '') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('department_id') is-invalid @enderror" 
                                        ...
                                        @foreach($departments as $department)
                                            <option value="{{ $department->id }}" {{ old('department_id', $lead->department_id) == $department->id ? 'selected' : '' }}>
