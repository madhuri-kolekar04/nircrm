        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-right">
                <span class="badge">
                    ...
                    Total Departments: {{ count($Department ?? []) }}
                </span>
            </div>
        </div>
    </div>
					...
					<div class="box department-card">
						<div class="box-header d-flex justify-content-between align-items-center">
							<h3 class="box-title mb-0">
								...
								Department List
								<span class="badge badge-primary ml-2">{{ count($Department ?? []) }}</span>
							</h3>
	 ...
	 <tr>
			...
			<div class="d-flex align-items-center">
				<div class="mr-3">
					<div class="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; font-weight: bold;">
						{{ mb_strtoupper(substr($item->department ?? 'D', 0, 1)) }}
					</div>
				</div>
				<div>
		...
		<td>
			<div class="btn-group" role="group">
				<a href="{{ route('Department.edit',$item->id) }}" class="btn btn-action btn-edit" title="Edit Department">
					<i class="fas fa-edit"></i> 
				</a>
				<a href="{{ route('Department.delete',$item->id) }}" class="btn btn-action btn-delete" title="Delete Department" id="delete">
			...
			<form method="post" action="{{ route('Department.store') }}" class="needs-validation" novalidate>
				...
				<div class="modal-body">
					<div class="form-group mb-4">
						...
						<input type="text" id="new_item_name" name="Department" class="form-control" placeholder="Enter department name" required> 
						@error('Department') 
