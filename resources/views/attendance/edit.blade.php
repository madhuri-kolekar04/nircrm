        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-white-50 mb-0">Update attendance details for {{ $attendance->user->name }}</p>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ route('attendance.show', $attendance->id) }}" class="btn btn-outline-light">
                                ...
                                <div class="alert employee-info-card">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fw-bold">{{ $attendance->user->name }}</h5>
                                            <p class="mb-0 opacity-90">{{ $attendance->user->getRoleNameAttribute() }}</p>
                                            @if($attendance->user->department)
                                                <p class="mb-0 opacity-75"><i class="fas fa-building me-1"></i>{{ $attendance->user->department->name }}</p>
                                            @endif
                                        </div>
                                        <div class="text-end">
                                            <div class="badge bg-white text-dark status-badge">
                                                <i class="fas fa-calendar me-1"></i>{{ $attendance->date->format('d M Y') }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="location" name="location" 
                                           value="{{ $attendance->location ?? 'Office' }}" placeholder="Enter location">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.1" class="form-control" id="working_hours" name="working_hours" 
                                           value="{{ $attendance->working_hours ?? '' }}" readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="floating-label">
                                    <textarea class="form-control" id="notes" name="notes" rows="4" 
                                              placeholder=" ">{{ $attendance->notes ?? '' }}</textarea>
