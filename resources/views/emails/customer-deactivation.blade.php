...
<head>
    ...
    <title>Customer Panel Access Deactivated</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 class="title">Customer Panel Access Deactivated</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="warning-box">
                <strong>Important Notice:</strong> Your customer panel access has been <strong>deactivated</strong>. You can no longer log in to your account.
            </div>
            ...
            <ul>
                ...
                <li>You cannot access quotation details online</li>
                <li>You cannot download invoices through the portal</li>
            </ul>
            ...
            <ul>
                ...
                <li>For any questions about your quotation or payment status, please reach out to your account manager</li>
