...
<div class="controls">
<input type="text"  name="Employee_id" class="form-control"  value="{{ $Employee->employeeID }}" readonly> 
@error('Employee_id') 
 ...
 <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="controls" style="position: relative;">
                <input type="password" id="password" name="Employee_password" class="form-control" value="{{ $Employee->password }}" placeholder="Enter New Password">
...
<div class="col-md-4">
<div class="form-group">
<h5>Managers of Department<span class="text-danger">*</span></h5>
<div class="controls">
<select name="Employee_department" class="form-control" required="" >
<option value="" selected="" disabled="">Select Department</option>
@foreach($Department as $item)
<option value="{{ $item->id }}" {{ $item->id == (is_object($Employee->department) ? $Employee->department->id : $Employee->department) ? 'selected' : '' }}>{{$item->department  }}</option>	
@endforeach
</select>
...
<option value="{{ $item->id }} "  {{ $item->id ==  $Employee->group ? 'selected' : '' }}>{{ $item->Group }}</option>	
@endforeach
</select>
@error('Group') 
<span class="text-danger">{{ $message }}</span>
