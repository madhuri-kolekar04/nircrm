...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('users', 'employee_id')) {
                $table->string('employee_id')->nullable()->after('manager_id');
            ...
            if (!Schema::hasColumn('users', 'work_shift')) {
                $table->string('work_shift')->default('9:00-18:00')->after('salary');
            }
    ...
    public function down(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->dropColumn(['department_id', 'manager_id', 'employee_id', 'joining_date', 'salary', 'work_shift', 'is_active', 'address', 'phone', 'date_of_birth']);
        });
    }
};
