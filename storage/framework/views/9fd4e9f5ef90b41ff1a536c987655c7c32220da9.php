...
@media (max-width: 768px) {
  ...
  <div class="container-full">
    ...
    <div class="department-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-right">
                <span class="badge">
                    ...
                    Total Departments: <?php echo e(count($category ?? [])); ?>
					...
					<div class="box department-card">
						<div class="box-header d-flex justify-content-between align-items-center">
							<h3 class="box-title mb-0">
								...
								Department List
								<span class="badge badge-primary ml-2"><?php echo e(count($category ?? [])); ?></span>
							</h3>
	 ...
	 <tr>
        <td><span class="badge badge-light font-weight-bold text-dark"><?php echo e($key + 1); ?></span></td>
			...
			<div class="d-flex align-items-center">
				<div class="mr-3">
					<div class="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; font-weight: bold;">
						<?php echo e(mb_strtoupper(substr($item->department, 0, 1))); ?>

					</div>
				</div>
				<div>
					<strong><?php echo e($item->department); ?></strong>
				</div>
			</div>
		</td>
		...
		<td>
			<div class="btn-group" role="group">
				<a href="<?php echo e(route('category.edit',$item->id)); ?>" class="btn btn-action btn-edit" title="Edit Department">
					<i class="fas fa-edit"></i> 
				</a>
				<a href="<?php echo e(route('category.delete',$item->id)); ?>" class="btn btn-action btn-delete" title="Delete Department" id="delete">
...
<div class="modal fade" id="addNewItemModal" tabindex="-1" aria-labelledby="addNewItemModalLabel" aria-hidden="true" data-bs-backdrop="false" data-bs-keyboard="false">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<form method="post" action="<?php echo e(route('category.store')); ?>" class="needs-validation" novalidate>
				<?php echo csrf_field(); ?>
