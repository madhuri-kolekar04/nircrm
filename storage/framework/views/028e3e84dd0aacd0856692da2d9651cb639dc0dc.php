<?php $__env->startSection('page-title', 'Sales Department - Qualified Leads'); ?>
...
<div class="container-fluid">
    ...
    <div class="lead-card">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-end">
                ...
                <a href="<?php echo e(route('quotations.index')); ?>" class="btn btn-warning btn-lg">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            <div class="stat-number" id="totalLeads"><?php echo e($qualifiedLeads->count()); ?></div>
    ...
    <div class="table-modern">
        <div class="table-responsive">
            <table class="table table-hover mb-0" id="leadsTable">
                ...
                <tbody>
                    <?php if(isset($qualifiedLeads) && $qualifiedLeads->count() > 0): ?>
                        <?php $__currentLoopData = $qualifiedLeads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="lead-row-<?php echo e($lead->id); ?>">
                            <td><?php echo e($index + 1); ?></td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar-sm bg-primary text-white rounded-circle d-flex align-items-center justify-content-center me-3">
                                        <?php echo e(strtoupper(substr($lead->name, 0, 2))); ?>

                                    </div>
                                    <div>
                                        <h6 class="mb-1 fw-bold"><?php echo e($lead->name); ?></h6>
                                        <small class="text-muted"><?php echo e($lead->company_name ?? 'No Company'); ?></small>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="contact-info">
                                    <div class="mb-2">
                                        ...
                                        <small><?php echo e($lead->email); ?></small>
                                    </div>
                                    <div>
                                        <i class="fas fa-phone text-muted me-2"></i>
                                        <small><?php echo e($lead->phone); ?></small>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="budget-priority">
                                    <div class="mb-2">
                                        <span class="badge bg-success">$<?php echo e(number_format($lead->budget ?? 0, 0)); ?></span>
                                    </div>
                                    <div>
                                        <span class="badge bg-<?php echo e($lead->getPriorityColor() ?? 'secondary'); ?>">
                                            <?php echo e(ucfirst($lead->priority ?? 'Medium')); ?>
                                    ...
                                    <?php if($lead->assignedUser): ?>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-xs bg-info text-white rounded-circle d-flex align-items-center justify-content-center me-2">
                                                <?php echo e(strtoupper(substr($lead->assignedUser->name, 0, 1))); ?>

                                            </div>
                                            <small><?php echo e($lead->assignedUser->name); ?></small>
                                        </div>
                                    <?php else: ?>
                            ...
                            <td>
                                <small><?php echo e($lead->created_at->format('M d, Y')); ?></small>
                            </td>
                            <td>
                                <div class="invoice-status">
                                    <span class="badge badge-status bg-<?php echo e($lead->getInvoiceStatusColor()); ?>" id="invoice-status-<?php echo e($lead->id); ?>">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $lead->invoice_status ?? 'waiting_for_approval'))); ?>

                                    </span>
                                    <?php if($lead->invoice_number): ?>
                                        <br><small class="text-muted"><?php echo e($lead->invoice_number); ?></small>
                                    <?php endif; ?>
                                </div>
                            </td>
                            <td>
                                <div class="action-buttons">
                                    <button class="btn btn-sm btn-info btn-action" onclick="viewLead(<?php echo e($lead->id); ?>)" title="View Details">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                    <button class="btn btn-sm btn-warning btn-action" onclick="editLead(<?php echo e($lead->id); ?>)" title="Edit Lead">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    
                                    <?php if(!$lead->invoice_number): ?>
                                        <a href="<?php echo e(route('sales.department.create-invoice', $lead->id)); ?>" class="btn btn-sm btn-success btn-action" title="Create Invoice">
                                            <i class="fas fa-file-invoice"></i>
                                        </a>
                                    <?php endif; ?>
                                    
                                    <?php if($lead->invoice_number && in_array($lead->invoice_status ?? 'waiting_for_approval', ['waiting_for_approval', 'waiting for approval'])): ?>
                                        <button class="btn btn-sm btn-primary btn-action" id="mail-btn-<?php echo e($lead->id); ?>" onclick="sendApprovalEmail(<?php echo e($lead->id); ?>, '<?php echo e($lead->email); ?>', '<?php echo e($lead->invoice_number); ?>')" title="Send Approval Email">
                                            <i class="fas fa-envelope"></i>
                                        </button>
                                    <?php endif; ?>
                                    
                                    <button class="btn btn-sm btn-danger btn-action" onclick="deleteLead(<?php echo e($lead->id); ?>)" title="Delete Lead">
