            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        Welcome back, <span class="fw-semibold"><?php echo e(Auth::user()->name); ?></span>!
                        <?php if(Auth::user()->department): ?>
                            <?php if(is_object(Auth::user()->department)): ?>
                                - <?php echo e(Auth::user()->department->name); ?> Department
                            <?php else: ?>
                                - <?php echo e(Auth::user()->department); ?> Department
                            <?php endif; ?>
                        <?php endif; ?>
                    </p>
                </div>
        ...
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h3 class="fw-bold mb-1 text-success"><?php echo e($stats['present']); ?></h3>
        ...
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h3 class="fw-bold mb-1 text-danger"><?php echo e($stats['absent']); ?></h3>
        ...
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h3 class="fw-bold mb-1 text-warning"><?php echo e($stats['onLeave']); ?></h3>
                ...
                <div class="card-header bg-light">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-semibold">
                            ...
                            Today's Attendance - <?php echo e(Carbon\Carbon::today()->format('d M Y')); ?>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <select class="form-select" id="departmentFilter" onchange="filterTable()">
                                ...
                                <?php $__currentLoopData = $users->pluck('department')->unique()->filter(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <table class="table table-hover mb-0" id="attendanceTable">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="attendance-row" data-department="<?php echo e($userItem->department->name ?? 'N/A'); ?>" data-name="<?php echo e($userItem->name); ?> <?php echo e($userItem->last_name ?? ''); ?>">
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="fw-semibold"><?php echo e($userItem->name); ?> <?php echo e($userItem->last_name ?? ''); ?></div>
                                                    <small class="text-muted"><?php echo e($userItem->role_name); ?></small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge bg-light text-dark"><?php echo e($userItem->department->name ?? 'N/A'); ?></span>
                                        </td>
                                        <td>
                                            <?php if($userItem->shift): ?>
                                                <div>
                                                    <span class="badge bg-info"><?php echo e($userItem->shift->name); ?></span>
                                                    <br><small class="text-muted"><?php echo e($userItem->shift->start_time->format('H:i')); ?> - <?php echo e($userItem->shift->end_time->format('H:i')); ?></small>
                                                </div>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <?php if($todayAttendances->has($userItem->id)): ?>
                                                <div>
                                                    <?php echo e($todayAttendances[$userItem->id]->check_in_time ? Carbon\Carbon::parse($todayAttendances[$userItem->id]->check_in_time)->format('H:i:s') : 'N/A'); ?>

                                                    <?php if($todayAttendances[$userItem->id]->is_late): ?>
                                        ...
                                        <td>
                                            <?php if($todayAttendances->has($userItem->id)): ?>
                                                <div>
                                                    <?php echo e($todayAttendances[$userItem->id]->check_out_time ? Carbon\Carbon::parse($todayAttendances[$userItem->id]->check_out_time)->format('H:i:s') : 'N/A'); ?>

                                                    <?php if($todayAttendances[$userItem->id]->is_early_checkout): ?>
                                        ...
                                        <td>
                                            <?php if($todayAttendances->has($userItem->id)): ?>
                                                <span class="fw-semibold"><?php echo e($todayAttendances[$userItem->id]->working_hours ?? 'N/A'); ?></span>
                                            <?php else: ?>
                                                <span class="text-muted">-</span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if($todayAttendances->has($userItem->id)): ?>
                                                <span class="badge bg-<?php echo e($todayAttendances[$userItem->id]->status == 'present' ? 'success' : ($todayAttendances[$userItem->id]->status == 'absent' ? 'danger' : 'warning')); ?>">
                                                    <?php echo e(ucfirst(str_replace('_', ' ', $todayAttendances[$userItem->id]->status))); ?>
                                        ...
                                        <td>
                                            <?php if(in_array(Auth::user()->role, [1, 5])): ?>
                                                <button class="btn btn-sm btn-outline-primary" onclick="editAttendance(<?php echo e($userItem->id); ?>, '<?php echo e(Carbon\Carbon::today()->format('Y-m-d')); ?>')">
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u314035009/domains/talktonitesh.com/public_html/nircrm/resources/views/attendance/dashboard.blade.php ENDPATH**/ ?>