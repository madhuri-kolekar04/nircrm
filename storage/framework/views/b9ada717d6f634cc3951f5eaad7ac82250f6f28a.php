<?php $__env->startSection('page-title', 'Create Invoice from Lead'); ?>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-file-invoice"></i> Create Invoice - <?php echo e($lead->name); ?>
                    ...
                    <div>
                        ...
                        <a href="<?php echo e(route('sales.department')); ?>" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="alert alert-info">
                                ...
                                <div class="row">
                                    <div class="col-md-3"><strong>Name:</strong> <?php echo e($lead->name); ?></div>
                                    <div class="col-md-3"><strong>Email:</strong> <?php echo e($lead->email); ?></div>
                                    <div class="col-md-3"><strong>Phone:</strong> <?php echo e($lead->phone); ?></div>
                                    <div class="col-md-3"><strong>Company:</strong> <?php echo e($lead->company_name ?? 'N/A'); ?></div>
                                </div>
                                <?php if($lead->budget): ?>
                                <div class="row mt-2">
                                    <div class="col-md-3"><strong>Budget:</strong> $<?php echo e(number_format($lead->budget, 2)); ?></div>
                                    <div class="col-md-3"><strong>Priority:</strong> <?php echo e(ucfirst($lead->priority)); ?></div>
                                    <div class="col-md-6"><strong>Address:</strong> <?php echo e($lead->address ?? 'N/A'); ?></div>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <form action="<?php echo e(route('sales.department.save-invoice', $lead->id)); ?>" method="POST" id="invoice-form">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm table-bordered">
                                        <tr>
                                            ...
                                            <td><?php echo e($invoiceNumber); ?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($lead->name); ?> (ID: <?php echo e($lead->id); ?>)</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control form-control-sm" name="client_business" 
                                                       value="<?php echo e($lead->company_name ?? ''); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <div class="alert alert-success mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4"><strong>Quotation Number:</strong> <?php echo e($latestQuotation->quotation_number); ?></div>
                                        <div class="col-md-4"><strong>Final Amount:</strong> $<?php echo e(number_format($latestQuotation->final_amount, 2)); ?></div>
                                        <div class="col-md-4"><strong>Approved Date:</strong> <?php echo e($latestQuotation->approved_at ? $latestQuotation->approved_at->format('M d, Y') : 'N/A'); ?></div>
                                    </div>
                                </div>
                                <?php endif; ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <input type="number" class="form-control bg-white" id="total_amount" name="total_amount" 
                                                       value="<?php echo e($totalAmount); ?>" step="0.01" min="0" onchange="updateGSTAndRemaining()">
                                                <small class="text-muted">Fetched from quotation final amount or lead budget</small>
                                                <input type="hidden" name="total_amount_backup" value="<?php echo e($totalAmount); ?>">
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="number" class="form-control bg-white" id="remaining_amount" name="remaining_amount" 
                                                       value="<?php echo e($totalAmount); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <div class="alert alert-info mb-3">
                                    <strong>Services from Quotation:</strong> <?php echo e($latestQuotation->quotation_number); ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php $counter = 1; ?>
                                            <?php if($latestQuotation && $latestQuotation->services->count() > 0): ?>
                                                <?php $__currentLoopData = $latestQuotation->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($counter++); ?></td>
                                                    <td><?php echo e($service->name); ?></td>
                                                    <td class="text-center"><?php echo e($service->pivot->quantity); ?></td>
                                                    <td class="text-right">$<?php echo e(number_format($service->pivot->price, 2)); ?></td>
                                                    <td class="text-right">$<?php echo e(number_format($service->pivot->subtotal, 2)); ?></td>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php else: ?>
                                                <tr>
                                                    <td><?php echo e($counter++); ?></td>
                                                    <td><?php echo e($lead->description ?? 'Professional Services as per lead requirements'); ?></td>
                                        ...
                                        <tfoot class="table-secondary">
                                            <tr>
                                                ...
                                                <td class="text-right" id="subtotal-amount">$<?php echo e(number_format($totalAmount, 2)); ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" class="text-right"><strong>GST (18%):</strong></td>
                                                <td class="text-right" id="gst-amount">$<?php echo e(number_format($totalAmount * 0.18, 2)); ?></td>
                                            </tr>
                                            <tr class="table-dark">
                                                <td colspan="4" class="text-right"><strong>Total Amount:</strong></td>
                                                <td class="text-right" id="total-amount-display"><strong>$<?php echo e(number_format($totalAmount * 1.18, 2)); ?></strong></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 text-center">
                                ...
                                <a href="<?php echo e(route('sales.department')); ?>" class="btn btn-secondary btn-lg">
