...
<body>
    <div class="app-container">
        ...
        <div class="stats-bar">
            <div class="stat-item">
                ...
                <span>Total Leads: <strong><?php echo e($totalRows); ?></strong></span>
            </div>
            <div class="stat-item">
                <i class="fas fa-file-alt"></i>
                <span>Page: <strong><?php echo e($page); ?> / <?php echo e($totalPages); ?></strong></span>
            </div>
            <div class="stat-item">
                <i class="fas fa-list"></i>
                <span>Showing: <strong><?php echo e(min($perPage, count($pageData))); ?></strong> per page</span>
            </div>
        </div>
        ...
        <div class="search-section">
            ...
            ?>
            <form method="GET" action="<?php echo e(route($searchRoute)); ?>">
                <input type="text" 
                       name="search" 
                       class="search-input" 
        ...
        <div class="tab-navigation">
            <button class="tab-btn <?php echo e(request()->routeIs('callingapp.manual-leads') ? '' : 'active'); ?>" onclick="switchTab('google')" id="google-tab">
                <i class="fas fa-sync"></i>
                Google Sheet
            </button>
            <button class="tab-btn <?php echo e(request()->routeIs('callingapp.manual-leads') ? 'active' : ''); ?>" onclick="switchTab('manual')" id="manual-tab">
                <i class="fas fa-user-plus"></i>
                Manual Leads
            </button>
        </div>
        ...
        <?php echo $__env->make('admin.google-sheets.calling-app-table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    ...
    <div class="custom-modal-overlay" id="logoutModal">
        <div class="custom-modal">
            ...
            <div class="modal-buttons">
                ...
                <form method="POST" action="<?php echo e(route('callingapp.logout')); ?>" style="display: inline;">
                    <?php echo csrf_field(); ?>
    ...
    function loadTodayFollowupCount() {
        fetch('<?php echo e(route('callingapp.today-followup-count')); ?>')
    ...
    function syncGoogleSheets(isAutoSync = false) {
        ...
        fetch('<?php echo e(route('callingapp.sync')); ?>', {
            method: 'POST',
            headers: {
    ...
    function loadGoogleSheetsData() {
        ...
        fetch(`<?php echo e(route('callingapp.index')); ?>?page=${page}&search=${search}`, {
            headers: {
    ...
    function loadGoogleSheetsDataWithPagination(page, search) {
        ...
        const newUrl = `<?php echo e(route('callingapp.index')); ?>?page=${page}&search=${search}`;
    ...
    function loadManualLeadsData() {
        ...
        fetch(`<?php echo e(route('callingapp.manual-leads')); ?>?page=${page}&search=${search}`, {
            headers: {
                'X-Requested-With': 'XMLHttpRequest'
            }
        })
    ...
    function loadManualLeadsDataWithPagination(page, search) {
        ...
        // Update URL without page reload
        const newUrl = `<?php echo e(route('callingapp.manual-leads')); ?>?page=${page}&search=${search}`;
...
<?php /**PATH C:\Users\Nilesh\Desktop\nircrm 12-5-26\resources\views/admin/google-sheets/calling-app.blade.php ENDPATH**/ ?>