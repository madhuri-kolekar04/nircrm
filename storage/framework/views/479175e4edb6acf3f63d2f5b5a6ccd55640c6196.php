...
(function($) {
    ...
    var showPopup = <?php echo e(session('show_attendance_popup', false)); ?>;
    ...
    function checkAndShowAttendancePopup() {
        ...
        var hasCheckedIn = localStorage.getItem('attendance_checked_in_' + <?php echo e(Auth::user()->id); ?>);
        ...
        $.get('/attendance/check-status')
            .done(function(response) {
                ...
                if (response.show_attendance && !response.already_checked_in) {
                    ...
                    localStorage.setItem('attendance_checked_in_' + <?php echo e(Auth::user()->id); ?>, today);
                }
            })
            .fail(function(xhr) {
    ...
    function showAttendancePopup(data) {
        var content = `
            <div class="text-center">
                ...
                <h5 class="fw-bold mb-3">Welcome, <?php echo e(Auth::user()->name); ?>!</h5>
    ...
    $('#quickCheckInBtn').click(function() {
        ...
        $.post('/attendance/check-in', {location: 'Office'})
            .done(function(response) {
                if (response.success) {
                    // Mark as checked in for today
                    localStorage.setItem('attendance_checked_in_' + <?php echo e(Auth::user()->id); ?>, new Date().toDateString());
...
<?php /**PATH /home/u314035009/domains/talktonitesh.com/public_html/nircrm/resources/views/partials/attendance-popup.blade.php ENDPATH**/ ?>