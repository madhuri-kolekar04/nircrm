...
<body>
        ...
        <div class="header-content">
            ...
            <div class="user-info-mobile">
                ...
                <div class="user-details-mobile">
                    <div class="user-name-mobile"><?php echo e(Auth::user()->name); ?></div>
                    <div class="user-email-mobile"><?php echo e(Auth::user()->email); ?></div>
                </div>
            </div>
    ...
    <div class="mobile-sidebar" id="mobileSidebar">
        ...
        <nav class="sidebar-nav">
            <a href="<?php echo e(route('employee.dashboard')); ?>" class="sidebar-nav-item active">
    ...
    .stats-grid {
        ...
        <section class="stats-grid" aria-label="Task Statistics">
            <div class="stat-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="stat-content">
                    <div class="stat-value"><?php echo e($totalTasks ?? 0); ?></div>
            ...
            <div class="stat-card success" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="stat-content">
                    <div class="stat-value"><?php echo e($completedTasks ?? 0); ?></div>
            ...
            <div class="stat-card warning" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="stat-content">
                    <div class="stat-value"><?php echo e($pendingTasks ?? 0); ?></div>
            ...
            <div class="stat-card info" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="stat-content">
                    <div class="stat-value"><?php echo e($inProgressTasks ?? 0); ?></div>
        ...
        <section class="task-list-section">
            ...
            <div id="taskContainer">
                ...
                <?php if(isset($groupedTasks) && count($groupedTasks) > 0): ?>
                    <?php
                        $delayCounter = 100;
                    ?>
                    <?php $__currentLoopData = $groupedTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupLabel => $tasksInGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="date-group-header <?php echo e($headerClass); ?>" data-aos="fade-up" data-aos-delay="<?php echo e($delayCounter); ?>">
                            ...
                            <button class="btn btn-sm btn-outline-primary send-daily-tasks-mail ms-2" data-date="<?php echo e($groupLabel); ?>" data-tasks="<?php echo e(json_encode(collect($tasksInGroup)->map(function($task) { return ['id' => $task->id, 'task_number' => $task->task_number, 'task_description' => $task->task_description, 'client_project_name' => $task->client_project_name, 'status' => $task->status, 'task_date' => $task->task_date->format('Y-m-d H:i:s')]; })->toArray())); ?>" title="Send daily tasks by mail">
                        ...
                        <?php $__currentLoopData = $tasksInGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="task-card" data-task-id="<?php echo e($task->id); ?>" data-aos="fade-up" data-aos-delay="<?php echo e($delayCounter); ?>">
                                <div class="task-header">
                                    <span class="task-number">Task #<?php echo e($task->task_number); ?></span>
                                    <div class="task-date">
                                        <i class="bi bi-calendar"></i>
                                        <span><?php echo e(\Carbon\Carbon::parse($task->task_date)->format('d-m-Y|h:i A')); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="task-section">
                                    ...
                                    <span><?php echo e($task->task_description); ?></span>
                                </div>
                                
                                <?php if(isset($task->status)): ?>
                                <div class="task-actions">
                                    <div class="status-badge status-<?php echo e($task->status); ?>">
                                        <?php echo e(str_replace('_', ' ', ucfirst($task->status))); ?>

                                    </div>
                                    <div class="task-buttons">
                                        <button type="button" class="btn btn-small btn-edit" onclick="editTask(<?php echo e($task->id); ?>)">
                                            <i class="bi bi-pencil"></i>
                                            <span>Edit</span>
                                        </button>
                                        <button type="button" class="btn btn-small btn-delete" onclick="deleteTask(<?php echo e($task->id); ?>)">
    ...
    <script>
        ...
        if (taskForm) {
            taskForm.addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    const response = await fetch('<?php echo e(route("employee.task.store")); ?>', {
                        method: 'POST',
                        body: formData,
                        headers: {
        ...
        async function editTask(taskId) {
            try {
                ...
                const response = await fetch(`<?php echo e(route("employee.task.edit", ":id")); ?>`.replace(':id', taskId));
        ...
        document.getElementById('editTaskForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route("employee.task.update", ":id")); ?>`.replace(':id', taskId), {
                    method: 'POST',
                    body: formData,
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')?.getAttribute('content') || ''
        ...
        async function deleteTask(taskId) {
            if (confirm('Are you sure you want to delete this task? This action cannot be undone.')) {
                try {
                    ...
                    const response = await fetch(`<?php echo e(route("employee.task.delete", ":id")); ?>`.replace(':id', taskId), {
                        method: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')?.getAttribute('content') || ''
                        }
...
<?php /**PATH C:\Users\Nilesh\Desktop\nircrm 12-5-26\resources\views/employee/dashboard.blade.php ENDPATH**/ ?>