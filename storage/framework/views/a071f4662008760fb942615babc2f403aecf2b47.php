<?php $__env->startSection('title', 'Attendance Reports - NIRCRM'); ?>
                            ...
                            <div class="row text-center">
                                <div class="col-3">
                                    <div class="border-end border-white-50">
                                        <h4 class="mb-0 text-white"><?php echo e($attendances->count()); ?></h4>
                                        <small class="text-white-50">Total Records</small>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="border-end border-white-50">
                                        <h4 class="mb-0 text-white"><?php echo e($attendances->where('status', 'present')->count()); ?></h4>
                                        <small class="text-white-50">Present</small>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="border-end border-white-50">
                                        <h4 class="mb-0 text-white"><?php echo e($attendances->where('status', 'absent')->count()); ?></h4>
                                        <small class="text-white-50">Absent</small>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <h4 class="mb-0 text-white"><?php echo e(number_format($attendances->sum('working_hours'), 1)); ?>h</h4>
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control" id="start_date" name="start_date" 
                                       value="<?php echo e($startDate->format('Y-m-d')); ?>" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label fw-semibold">
                                ...
                                <input type="date" class="form-control" id="end_date" name="end_date" 
                                       value="<?php echo e($endDate->format('Y-m-d')); ?>" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label fw-semibold">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="text-white mb-0"><?php echo e($attendances->where('status', 'present')->count()); ?></h3>
                            <small class="text-white-50">
                                <?php echo e($attendances->count() > 0 ? round(($attendances->where('status', 'present')->count() / $attendances->count()) * 100, 1) : 0); ?>% attendance rate
                            </small>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="text-white mb-0"><?php echo e($attendances->where('status', 'absent')->count()); ?></h3>
                            <small class="text-white-50">
                                <?php echo e($attendances->count() > 0 ? round(($attendances->where('status', 'absent')->count() / $attendances->count()) * 100, 1) : 0); ?>% absence rate
                            </small>
                        </div>
                        <div class="rounded-circle bg-white bg-opacity-25 p-3">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="text-white mb-0"><?php echo e(number_format($attendances->sum('working_hours'), 1)); ?>h</h3>
                            <small class="text-white-50">
                                Avg: <?php echo e($attendances->count() > 0 ? number_format($attendances->sum('working_hours') / $attendances->count(), 1) : 0); ?>h/day
                            </small>
                        </div>
                        <div class="rounded-circle bg-white bg-opacity-25 p-3">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="text-white mb-0"><?php echo e(number_format($attendances->sum('overtime_hours'), 1)); ?>h</h3>
                            <small class="text-white-50">
                                <?php echo e($userSummaries->where('overtimeHours', '>', 0)->count()); ?> users with OT
                            </small>
                        </div>
                        <div class="rounded-circle bg-white bg-opacity-25 p-3">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-light py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-primary"><?php echo e($userSummaries->count()); ?> Employees</span>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover" id="userSummaryTable">
                            ...
                            <tbody>
                                <?php if($userSummaries->count() > 0): ?>
                                    <?php $__currentLoopData = $userSummaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $summary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded-circle bg-primary bg-opacity-10 text-primary d-flex align-items-center justify-content-center me-3" 
                                                         style="width: 40px; height: 40px; font-size: 16px; font-weight: bold;">
                                                        <?php echo e(strtoupper(substr($summary['user']->name, 0, 1))); ?>

                                                    </div>
                                                    <div>
                                                        <div class="fw-bold text-dark"><?php echo e($summary['user']->name); ?></div>
                                                        <small class="text-muted"><?php echo e($summary['user']->getRoleNameAttribute()); ?></small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if($summary['user']->department): ?>
                                                    <span class="badge bg-info bg-opacity-10 text-info px-3 py-1">
                                                        <?php if(is_object($summary['user']->department)): ?>
                                                            <?php echo e($summary['user']->department->name); ?>

                                                        <?php else: ?>
                                                            <?php echo e($summary['user']->department); ?>
                                            ...
                                            <td class="text-center">
                                                <span class="badge bg-secondary"><?php echo e($summary['totalDays']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-success"><?php echo e($summary['present']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-danger"><?php echo e($summary['absent']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-info"><?php echo e($summary['onLeave']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-warning"><?php echo e($summary['halfDay']); ?></span>
                                        </td>
                                        <td class="text-center">
                                            <strong><?php echo e(number_format($summary['totalHours'], 1)); ?>h</strong>
                                        </td>
                                        <td class="text-center">
                                            <?php if($summary['overtimeHours'] > 0): ?>
                                                <span class="text-success fw-bold">+<?php echo e(number_format($summary['overtimeHours'], 1)); ?>h</span>
                                            <?php else: ?>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm">
                                                <button type="button" class="btn btn-outline-primary view-details" 
                                                        data-user-id="<?php echo e($summary['user']->id); ?>" data-user-name="<?php echo e($summary['user']->name); ?>">
                            ...
                            <tbody>
                                <?php if($attendances->count() > 0): ?>
                                    <?php $__currentLoopData = $attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <div class="fw-bold"><?php echo e($attendance->date->format('d M Y')); ?></div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="fw-bold"><?php echo e($attendance->user->name); ?></div>
                                                    <small class="text-muted"><?php echo e($attendance->user->getRoleNameAttribute()); ?></small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <?php if($attendance->user->department): ?>
                                                <span class="badge bg-info bg-opacity-10 text-info px-2 py-1">
                                                    <?php if(is_object($attendance->user->department)): ?>
                                                        <?php echo e($attendance->user->department->name); ?>

                                                    <?php else: ?>
                                                        <?php echo e($attendance->user->department); ?>
                                        ...
                                        <td class="text-center">
                                            <strong>
                                                <?php if($attendance->working_hours): ?>
                                                    <?php echo e(number_format($attendance->working_hours, 1)); ?>h
                                                <?php else: ?>
                                                    -
                                                <?php endif; ?>
                                            </strong>
                                        ...
                                        <td class="text-center">
                                            <?php if($attendance->overtime_hours > 0): ?>
                                                <span class="text-success fw-bold">+<?php echo e(number_format($attendance->overtime_hours, 1)); ?>h</span>
                                            <?php else: ?>
                                                -
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            ?>
                                            <span class="badge bg-<?php echo e($color); ?>"><?php echo e(ucfirst(str_replace('_', ' ', $attendance->status))); ?></span>
                                        </td>
                                        <td>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="email_subject" name="email_subject" 
                                       value="NIRCRM Attendance Report - <?php echo e($startDate->format('d M Y')); ?> to <?php echo e($endDate->format('d M Y')); ?>" required>
                            </div>
                        </div>
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="email_message" name="email_message" rows="4" 
                                          placeholder="Add a custom message (optional)">Please find attached the attendance report for the period <?php echo e($startDate->format('d M Y')); ?> to <?php echo e($endDate->format('d M Y')); ?>.</textarea>
                            </div>
                        </div>
                        <div class="row g-3">
                            <div class="col-md-6">
...
$(document).ready(function() {
    ...
    $('#reportFilterForm').submit(function(e) {
        ...
        window.location.href = '<?php echo e(route("attendance.report")); ?>?' + formData;
    });
    
    // Reset filters
    $('#resetFilters').click(function() {
        $('#reportFilterForm')[0].reset();
        window.location.href = '<?php echo e(route("attendance.report")); ?>';
    });
    ...
    $('#downloadPDF').click(function() {
        ...
        setTimeout(function() {
            ...
            doc.text('Period: <?php echo e($startDate->format("d M Y")); ?> - <?php echo e($endDate->format("d M Y")); ?>', 14, 30);
            ...
            doc.setFontSize(10);
            doc.text('Total Records: <?php echo e($attendances->count()); ?>', 14, 60);
            doc.text('Present: <?php echo e($attendances->where("status", "present")->count()); ?>', 14, 67);
            doc.text('Absent: <?php echo e($attendances->where("status", "absent")->count()); ?>', 14, 74);
            doc.text('Total Hours: <?php echo e(number_format($attendances->sum("working_hours"), 2)); ?>h', 14, 81);
            ...
            doc.save('attendance_report_<?php echo e($startDate->format("Y-m-d")); ?>_to_<?php echo e($endDate->format("Y-m-d")); ?>.pdf');
    ...
    $('#downloadExcel').click(function() {
        ...
        setTimeout(function() {
            ...
            var summaryData = [
                ...
                ['Period', '<?php echo e($startDate->format("d M Y")); ?> - <?php echo e($endDate->format("d M Y")); ?>'],
                ['Generated', new Date().toLocaleDateString()],
                [],
                ['Total Records', '<?php echo e($attendances->count()); ?>'],
                ['Present', '<?php echo e($attendances->where("status", "present")->count()); ?>'],
                ['Absent', '<?php echo e($attendances->where("status", "absent")->count()); ?>'],
                ['Total Hours', '<?php echo e(number_format($attendances->sum("working_hours"), 2)); ?>h'],
                ['Overtime Hours', '<?php echo e(number_format($attendances->sum("overtime_hours"), 2)); ?>h']
            ];
            ...
            var filename = 'NIRCRM_attendance_report_<?php echo e($startDate->format("Y-m-d")); ?>_to_<?php echo e($endDate->format("Y-m-d")); ?>.xlsx';
    ...
    $('.export-user').click(function() {
        ...
        setTimeout(function() {
            ...
            var filename = 'NIRCRM_' + userName.replace(/\s+/g, '_') + '_attendance_<?php echo e($startDate->format("Y-m-d")); ?>_to_<?php echo e($endDate->format("Y-m-d")); ?>.xlsx';
            XLSX.writeFile(wb, filename);
    ...
    $('#sendEmailReport').click(function() {
        ...
        emailContent += '<p><strong>Period:</strong> <?php echo e($startDate->format("d M Y")); ?> - <?php echo e($endDate->format("d M Y")); ?></p>';
        emailContent += '<p><strong>Generated:</strong> ' + new Date().toLocaleDateString() + '</p>';
        
        if (includeSummary) {
            emailContent += '<h3>Summary Statistics</h3>';
            emailContent += '<ul>';
            emailContent += '<li>Total Records: <?php echo e($attendances->count()); ?></li>';
            emailContent += '<li>Present: <?php echo e($attendances->where("status", "present")->count()); ?></li>';
            emailContent += '<li>Absent: <?php echo e($attendances->where("status", "absent")->count()); ?></li>';
            emailContent += '<li>Total Hours: <?php echo e(number_format($attendances->sum("working_hours"), 2)); ?>h</li>';
            emailContent += '</ul>';
        }
        ...
        // Send email via AJAX
        $.ajax({
            url: '<?php echo e(route("attendance.send.email")); ?>',
            method: 'POST',
            data: {
