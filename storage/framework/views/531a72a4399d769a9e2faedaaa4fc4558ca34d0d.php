<?php $__env->startSection('page-title', 'Professional Invoice Management'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="alert alert-warning">
                ...
                <p>Please <a href="<?php echo e(route('login')); ?>" class="alert-link">login to your account</a> to access the invoice management system.</p>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-md-end mt-3 mt-md-0">
                            <?php if(auth()->user()->role == 1 || auth()->user()->role == 5): ?>
                                <a href="<?php echo e(route('invoices.create')); ?>" class="btn btn-light btn-lg me-2">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold"><?php echo e($paidInvoices ?? 0); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold"><?php echo e($pendingInvoices ?? 0); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold">₹<?php echo e(number_format($totalRevenue ?? 0, 0)); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-md-end">
                            <div class="text-muted">
                                User: <?php echo e(auth()->user()->email); ?> (Role: <?php echo e(auth()->user()->role); ?>)
                                <?php if(auth()->user()->role == 1 || auth()->user()->role == 5): ?>
                ...
                <div class="card-body">
                    ...
                    <?php if($invoices->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-hover" id="invoicesTable">
                                ...
                                <tbody>
                                    ...
                                    <tr data-invoice-id="<?php echo e($invoice->id); ?>">
                                        <td><?php echo e($counter++); ?></td>
                                        <td>
                                            <div class="fw-bold text-primary"><?php echo e($invoice->invoice_number); ?></div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="rounded-circle bg-primary bg-opacity-10 text-primary rounded-circle d-flex align-items-center justify-content-center me-2" style="width: 32px; height: 32px; font-size: 12px; font-weight: 600;">
                                                    <?php echo e(strtoupper(substr($invoice->customer_name, 0, 1))); ?>

                                                </div>
                                                <div>
                                                    <div class="fw-semibold"><?php echo e($invoice->customer_name); ?></div>
                                                    <small class="text-muted"><?php echo e($invoice->customer_email); ?></small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge bg-light text-dark"><?php echo e($invoice->project_name ?? 'N/A'); ?></span>
                                        </td>
                                        <td>
                                            <span class="badge bg-success">₹<?php echo e(number_format($invoice->total_payment, 0)); ?></span>
                                        </td>
                                        <td>
                                            <span class="badge bg-info">₹<?php echo e(number_format($invoice->advance_payment, 0)); ?></span>
                                        </td>
                                        <td>
                                            <span class="badge bg-warning">₹<?php echo e(number_format($invoice->remaining_payment, 0)); ?></span>
                                        </td>
                                        <td>
                                            <span class="badge bg-<?php echo e($invoice->status == 'paid' ? 'success' : ($invoice->status == 'pending' ? 'warning' : 'danger')); ?>">
                                                <?php echo e(ucfirst($invoice->status)); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <div><?php echo e($invoice->invoice_date->format('d M Y')); ?></div>
                                            <small class="text-muted"><?php echo e($invoice->invoice_date->diffForHumans()); ?></small>
                                        </td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                <!-- View Button - Always available for authenticated users -->
                                                <a href="<?php echo e(route('invoices.view', $invoice)); ?>" class="btn btn-sm btn-outline-primary" title="View Invoice">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                
                                                <?php if(auth()->check() && (auth()->user()->role == 1 || auth()->user()->role == 5)): ?>
                                                    <!-- Edit Button - Admin only -->
                                                    <a href="<?php echo e(route('invoices.edit', $invoice)); ?>" class="btn btn-sm btn-outline-warning" title="Edit Invoice">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    
                                                    <!-- Email Button - Admin only -->
                                                    <button type="button" class="btn btn-sm btn-outline-success" onclick="sendInvoiceEmail(<?php echo e($invoice->id); ?>)" title="Send Email">
                                                        <i class="fas fa-envelope"></i>
                                                    </button>
                                                    
                                                    <!-- Download Button - Admin only -->
                                                    <a href="<?php echo e(route('invoices.export.pdf', $invoice)); ?>" class="btn btn-sm btn-outline-info" title="Download PDF" target="_blank">
                                                        <i class="fas fa-download"></i>
                                                    </a>
                                                    
                                                    <!-- Delete Button - Admin only -->
                                                    <button type="button" class="btn btn-sm btn-outline-danger" onclick="deleteInvoice(<?php echo e($invoice->id); ?>)" title="Delete Invoice">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <div class="text-muted">
                                Showing <?php echo e($invoices->firstItem() ?? 0); ?> to <?php echo e($invoices->lastItem() ?? 0); ?> of <?php echo e($invoices->total()); ?> entries
                            </div>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u314035009/domains/talktonitesh.com/public_html/nircrm/resources/views/admin/invoices/working_index.blade.php ENDPATH**/ ?>