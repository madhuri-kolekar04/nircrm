<?php $__env->startSection('page-title', 'Create Leave Request'); ?>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="<?php echo e(route('leave.index')); ?>" class="btn btn-outline-primary">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            <h5 class="mb-1 fw-semibold"><?php echo e($user->name); ?> <?php echo e($user->last_name ?? ''); ?></h5>
                            <p class="text-muted mb-0"><?php echo e($user->designation ?? 'Employee'); ?></p>
                            <p class="text-muted mb-0"><?php echo e($user->department->name ?? 'No Department'); ?></p>
                        </div>
                    </div>
                    <div class="row text-center">
                        <div class="col-6">
                            <div class="border-end">
                                <div class="fw-bold text-primary"><?php echo e($user->employee_id ?? 'N/A'); ?></div>
                                <small class="text-muted">Employee ID</small>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="fw-bold text-success"><?php echo e(\Carbon\Carbon::parse($user->joining_date ?? now())->diffInYears(now())); ?> Years</div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="approval-flow">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <small class="text-muted"><?php echo e($user->name); ?> (<?php echo e($user->role_name ?? 'Employee'); ?>)</small>
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1">
                                <div class="fw-semibold"><?php echo e($nextApproverName); ?></div>
                                <small class="text-muted"><?php echo e($nextApproverTitle); ?></small>
                            </div>
                            <?php if($user->role != 1): ?>
                                <i class="fas fa-arrow-down text-muted"></i>
                            <?php endif; ?>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <div class="fw-semibold">
                                    <?php if($user->role == 3): ?>
                                        <?php $gm = \App\Models\User::where('role', 5)->first(); ?>
                                        <?php echo e($gm->name ?? 'Not Assigned'); ?>

                                    <?php else: ?>
                                        <?php $admin = \App\Models\User::where('role', 1)->first(); ?>
                                        <?php echo e($admin->name ?? 'Not Assigned'); ?>
                    ...
                    <div class="alert alert-info mt-3 mb-0">
                        ...
                        <strong>Approval Process:</strong> Your leave request will be sent to <?php echo e($nextApproverName); ?> for approval.
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="card border-left-info shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><?php echo e($type->name); ?></div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($balance['available_days']); ?> days</div>
                                                <div class="text-xs text-gray-500">Available of <?php echo e($balance['total_days']); ?> total</div>
                                                
                                                <!-- Progress bar for usage -->
                                                <?php if($balance['total_days'] > 0): ?>
                                                    <?php
                                                    ...
                                                    <div class="progress mt-2" style="height: 6px;">
                                                        <div class="progress-bar <?php echo e($progressColor); ?>" role="progressbar" 
                                                             style="width: <?php echo e($balance['usage_percentage']); ?>%"
                                                             aria-valuenow="<?php echo e($balance['usage_percentage']); ?>" 
                                                             aria-valuemin="0" aria-valuemax="100">
                                                        </div>
                                                    </div>
                                                    <div class="text-xs text-gray-500 mt-1">
                                                        Used: <?php echo e($balance['used_days']); ?> days
                                                        <?php if($balance['pending_days'] > 0): ?>
                                                            <span class="text-warning">| Pending: <?php echo e($balance['pending_days']); ?> days</span>
                                                        <?php endif; ?>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('leave.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="leave_type_id" name="leave_type_id" required>
                                    ...
                                    <?php $__currentLoopData = $leaveTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($type->id); ?>"><?php echo e($type->name); ?> (<?php echo e($type->days_per_year); ?> days/year)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('leave.index')); ?>" class="btn btn-secondary">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mt-3">
                ...
                <div class="card-body">
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <strong>Annual Leave:</strong> <?php echo e($leaveTypes->where('name', 'Annual Leave')->first()->days_per_year ?? 'N/A'); ?> days per year
                        </li>
                        <li class="mb-2">
                            <strong>Sick Leave:</strong> <?php echo e($leaveTypes->where('name', 'Sick Leave')->first()->days_per_year ?? 'N/A'); ?> days per year
                        </li>
                        <li class="mb-2">
                            <strong>Personal Leave:</strong> <?php echo e($leaveTypes->where('name', 'Personal Leave')->first()->days_per_year ?? 'N/A'); ?> days per year
                        </li>
                        <li class="mb-2">
