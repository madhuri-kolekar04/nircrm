<?php $__env->startSection('page-title', 'Project Completion Status'); ?>
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">
                        ...
                        <?php if(isset($project)): ?>
                            - <?php echo e($project->product_name_en); ?>

                        <?php elseif(isset($invoice)): ?>
                            - <?php echo e($invoice->project_name); ?>

                        <?php endif; ?>
                    </h5>
                    <a href="<?php echo e(route('project-updates.show', isset($project) ? $project->id : $invoice->id)); ?>" class="btn btn-secondary">
                            ...
                            <div class="progress mb-3" style="height: 30px;">
                                <?php $__currentLoopData = $completionStatus->formatted_status_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="progress-bar" role="progressbar" 
                                         style="width: <?php echo e($item['percentage']); ?>%; background-color: <?php echo e($item['color']); ?>;"
                                        ...
                                        <div class="card border-left" style="border-left-color: <?php echo e($item['color']); ?> !important; border-left-width: 4px !important;">
                                            <div class="card-body py-2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <small class="text-muted"><?php echo e($item['order']); ?>.</small>
                                                    <span class="badge" style="background-color: <?php echo e($item['color']); ?>;"><?php echo e($item['percentage']); ?>%</span>
                                                </div>
                                                <div class="mt-1"><?php echo e($item['text']); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="progress-container mb-4" style="position: relative;">
                                        ...
                                        <?php $__currentLoopData = $completionStatus->formatted_status_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="progress-segment" 
                                                 ...
                                                 <?php elseif($isPartial): ?>
                                                     ...
                                                     title="<?php echo e($item['text']); ?>: <?php echo e($item['percentage']); ?>%">
                                                     <span class="segment-text" style="color: <?php echo e($completionPercentage > 50 ? '#ffffff' : '#6c757d'); ?>;"><?php echo e($item['text']); ?></span>
                                                 <?php else: ?>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4 text-end">
                                            <small class="text-muted">Progress: <span id="progressText" class="fw-bold"><?php echo e($completionStatus->exact_percentage ?? 0); ?>%</span></small>
                                        </div>
                                    </div>
                                </div>
...
<div class="modal fade" id="createCompletionStatusModal" tabindex="-1" aria-labelledby="createCompletionStatusModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('project-updates.completion-status.store', isset($project) ? $project->id : $invoice->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="editCompletionStatusModal" tabindex="-1" aria-labelledby="editCompletionStatusModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('project-updates.completion-status.update', $completionStatus->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <div id="editStatusItemsContainer">
                            <?php $__currentLoopData = $completionStatus->status_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="status-item-row mb-3">
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            <input type="text" name="status_items[]" class="form-control" value="<?php echo e($item); ?>" placeholder="Enter completion stage..." required>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                <span class="badge bg-primary me-2 percentage-display"><?php echo e($completionStatus->formatted_status_items[$index]['percentage']); ?>%</span>
                                                <button type="button" class="btn btn-sm btn-outline-danger remove-item" <?php if(count($completionStatus->status_items) <= 1): ?> style="display: none;" <?php endif; ?>>
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                            </div>
                                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (progressBar) {
        ...
        function autoSaveProgress(exactPercentage) {
            ...
            const fetchUrl = '<?php echo e(route("project-updates.progress.update", isset($project) ? $project->id : $invoice->id)); ?>';
        ...
        if (saveProgressBtn) {
            saveProgressBtn.addEventListener('click', function() {
                ...
                form.method = 'POST';
                form.action = '/project-updates/<?php echo e(isset($project) ? $project->id : $invoice->id); ?>/update-progress';
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u314035009/domains/talktonitesh.com/public_html/nircrm/resources/views/project_updates/completion_status.blade.php ENDPATH**/ ?>