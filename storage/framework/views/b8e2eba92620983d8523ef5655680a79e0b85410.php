<?php $__env->startSection('page-title', 'Calendar Leaves'); ?>
    ...
    <div class="row mb-4">
        <div class="col-md-2 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm bg-gradient-primary text-white">
                <div class="card-body text-center">
                    <div class="fs-2 fw-bold"><?php echo e($leaves->count()); ?></div>
        ...
        <div class="col-md-2 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm bg-gradient-success text-white">
                <div class="card-body text-center">
                    <div class="fs-2 fw-bold"><?php echo e($leaves->where('status', 'approved')->count()); ?></div>
        ...
        <div class="col-md-2 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm bg-gradient-warning text-white">
                <div class="card-body text-center">
                    <div class="fs-2 fw-bold"><?php echo e($leaves->where('status', 'pending')->count()); ?></div>
        ...
        <div class="col-md-2 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm bg-gradient-danger text-white">
                <div class="card-body text-center">
                    <div class="fs-2 fw-bold"><?php echo e($leaves->where('status', 'rejected')->count()); ?></div>
        ...
        <div class="col-md-2 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm bg-gradient-info text-white">
                <div class="card-body text-center">
                    <div class="fs-2 fw-bold"><?php echo e(count($holidays)); ?></div>
        ...
        <div class="col-md-2 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm bg-gradient-secondary text-white">
                <div class="card-body text-center">
                    <div class="fs-2 fw-bold"><?php echo e($leaves->sum('total_days')); ?></div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-semibold">
                        ...
                        Calendar View - <?php echo e(\Carbon\Carbon::createFromDate($year, $month, 1)->format('F Y')); ?>
                        ...
                        <?php $__currentLoopData = $holidays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $holiday): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-4 col-sm-6 mb-3">
                                <div class="d-flex align-items-center p-3 border rounded">
                                    ...
                                    <div>
                                        <h6 class="mb-1 fw-bold"><?php echo e($holiday['name']); ?></h6>
                                        <p class="mb-0 text-muted small"><?php echo e(\Carbon\Carbon::parse($holiday['date'])->format('d M Y')); ?></p>
                                        <span class="badge bg-<?php echo e($holiday['type'] == 'national' ? 'danger' : ($holiday['type'] == 'company' ? 'info' : 'primary')); ?> bg-opacity-10 text-<?php echo e($holiday['type'] == 'national' ? 'danger' : ($holiday['type'] == 'company' ? 'info' : 'primary')); ?>">
...
<div class="modal fade" id="holidaysModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="fas fa-gift me-2"></i>Company Holidays <?php echo e($year); ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $holidays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $holiday): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-<?php echo e($holiday['type'] == 'national' ? 'danger' : ($holiday['type'] == 'company' ? 'info' : 'primary')); ?>">
                                            <?php echo e(ucfirst($holiday['type'])); ?>
                                    ...
                                    <td>
                                        <?php if($daysUntil > 0): ?>
                                            <span class="text-success"><?php echo e($daysUntil); ?> days</span>
