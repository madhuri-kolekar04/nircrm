    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('leads.update.new', $lead->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="name" name="name" value="<?php echo e(old('name', $lead->name)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__currentLoopData = App\Models\Lead::getPriorities(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value); ?>" <?php echo e(old('priority', $lead->priority ?? 'medium') == $value ? 'selected' : ''); ?>>
                                                <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                               ...
                                               value="<?php echo e(old('custom_source')); ?>" placeholder="Enter custom source" maxlength="255">
...
unset($__errorArgs, $__bag); ?>" 
                                           id="follow_up_date" name="follow_up_date" value="<?php echo e(old('follow_up_date', $lead->follow_up_date ? $lead->follow_up_date->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                           id="budget" name="budget" value="<?php echo e(old('budget', $lead->budget)); ?>" step="0.01" min="0">
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>" <?php echo e(old('department_id', $lead->department_id) == $category->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                              id="notes" name="notes" rows="3"><?php echo e(old('notes', $lead->notes)); ?></textarea>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select <?php $__errorArgs = ['work_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="">Select Status</option>
                                        <option value="Active" <?php echo e(old('work_status', $lead->work_status) == 'Active' ? 'selected' : ''); ?>>Active</option>
                                        <option value="NO" <?php echo e(old('work_status', $lead->work_status) == 'NO' ? 'selected' : ''); ?>>NO</option>
                                    </select>
                                    <?php $__errorArgs = ['work_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?php $__errorArgs = ['work_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           id="work_type" name="work_type" value="<?php echo e(old('work_type', $lead->work_type)); ?>" placeholder="Enter work type">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?php $__errorArgs = ['current_service'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           id="current_service" name="current_service" value="<?php echo e(old('current_service', $lead->current_service)); ?>" placeholder="Enter current service">
                                    <?php $__errorArgs = ['current_service'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control <?php $__errorArgs = ['date_of_completion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           id="date_of_completion" name="date_of_completion" value="<?php echo e(old('date_of_completion', $lead->date_of_completion ? $lead->date_of_completion->format('Y-m-d') : '')); ?>">
                                    <?php $__errorArgs = ['date_of_completion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="due_date" name="due_date" value="<?php echo e(old('due_date', $lead->due_date ? $lead->due_date->format('Y-m-d') : '')); ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const predefinedSources = <?php echo json_encode(App\Models\Lead::getSources(), 15, 512) ?>;
