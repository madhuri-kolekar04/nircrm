<?php $__env->startSection('title'); ?>
    Page Customization - <?php echo e($menuName ?? ''); ?>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <small class="text-muted">URL: <?php echo e($menuUrl ?? ''); ?></small>
                        </div>
                        <div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <strong>Menu Name:</strong> <?php echo e($menuName ?? ''); ?>

                                </div>
                                <div class="col-md-3">
                                    <strong>Menu URL:</strong> <?php echo e($menuUrl ?? ''); ?>

                                </div>
                                <div class="col-md-3">
                                    <strong>Role ID:</strong> <?php echo e($roleId ?? 'All Roles'); ?>

                                </div>
                                <div class="col-md-3">
                                    <strong>Employee ID:</strong> <?php echo e($employeeId ?? 'All Employees'); ?>
                        ...
                        <?php if($customizations->count() > 0): ?>
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <?php $__currentLoopData = $customizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="card mb-3">
                                            <div class="card-header bg-light">
                                                <h5 class="mb-0 text-capitalize"><?php echo e($type); ?> Elements</h5>
                                            </div>
                                            <div class="card-body">
                                                    ...
                                                    <table class="table table-sm table-bordered">
                                                        ...
                                                        <tbody>
                                                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr data-customization-id="<?php echo e($item->id); ?>">
                                                                    <td><?php echo e($index + 1); ?></td>
                                                                    <td><?php echo e($item->element_name); ?></td>
                                                                    <td><code><?php echo e($item->element_identifier ?: 'N/A'); ?></code></td>
                                                                    <td class="text-center">
                                                                        <div class="custom-control custom-switch">
                                                                            <input type="checkbox" 
                                                                                   class="custom-control-input visibility-toggle" 
                                                                                   id="visibility_<?php echo e($item->id); ?>"
                                                                                   <?php echo e($item->is_visible ? 'checked' : ''); ?>

                                                                                   data-id="<?php echo e($item->id); ?>">
                                                                            <label class="custom-control-label" for="visibility_<?php echo e($item->id); ?>">
                                                                                <?php echo e($item->is_visible ? 'Show' : 'Hide'); ?>
...
<script>
    const menuName = '<?php echo e($menuName); ?>';
    const menuUrl = '<?php echo e($menuUrl); ?>';
    const roleId = '<?php echo e($roleId); ?>' === '' ? null : '<?php echo e($roleId); ?>';
    const employeeId = '<?php echo e($employeeId); ?>' === '' ? null : '<?php echo e($employeeId); ?>';
    ...
    function analyzePage() {
        ...
        $.ajax({
            url: '<?php echo e(route("page-customization.analyze")); ?>',
            method: 'POST',
            data: {
    ...
    function bindVisibilityToggles() {
        $('.element-visibility').on('change', function() {
            ...
            $.ajax({
                url: '<?php echo e(route("page-customization.update-single")); ?>',
                method: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    menu_name: menuName,
    ...
    function saveAllCustomizations() {
        ...
        $.ajax({
            url: '<?php echo e(route("page-customization.store")); ?>',
            method: 'POST',
            data: payload,
            success: function(response) {
                if (response.success) {
    ...
    function updateVisibility(id, isVisible) {
        $.ajax({
            url: '<?php echo e(route("page-customization.batch-update")); ?>',
            method: 'POST',
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
                items: [{
    ...
    function deleteCustomization(id) {
        ...
        $.ajax({
            url: '<?php echo e(route("page-customization.destroy", "")); ?>/' + id,
            method: 'DELETE',
            data: {
                _token: '<?php echo e(csrf_token()); ?>'
            },
